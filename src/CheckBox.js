 ...
 */
const CheckBox = function(options) {
  this._childNum = 0;
  this._checkedChild = [];
  ...
  this.click = function() {
    ...
    const checked = !that.options.data.checked;
...
CheckBox.prototype = {
  ...
  check: function(checked, noFire) {
    ...
    checked ? 
      $li.find('i').removeClass('icon-cb-unchecked').addClass('icon-cb-checked') 
        : 
      $li.find('i').removeClass('icon-cb-checked').addClass('icon-cb-unchecked'); 
